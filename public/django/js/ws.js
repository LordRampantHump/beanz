if (typeof window.FontAwesomeKitConfig === 'undefined') {
	...
	circ.style.cssText = 'position: fixed;z-index: 9999;left: 25px;bottom: 25px;opacity: 0.75;transition-timing-function: ease;transition-duration: .4s;transition-property: opacity, transform;';
